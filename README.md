...
- Модификаторы доступа (*public*, *private*, *protected*) всегда должны быть прописаны
- Все *private* и *protected* переменные должны начинаться со знака **_**
- По возможности вместо прямого прописывания типа, необходимо использовать **var**
## Unity проект
